...
const ArticleTeaser = ({ article }) => {
    ...
    return (
        <li key={article.documentId} className={styles.article__teaser} id={article.slug}>
            ...
            <div className={`${styles.article__teaser_image} ${styles.image_background} desktop`} ref={imageRefDesktop}>
            ...
            <div ref={contentRef} className={styles.article__teaser_content}>
